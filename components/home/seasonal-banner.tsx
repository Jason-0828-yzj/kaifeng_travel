...
export function SeasonalBanner() {
  return (
    <section className="section-space pt-8 lg:pt-10">
      <Container>
        <div className="panel-strong overflow-hidden bg-[linear-gradient(135deg,rgba(139,46,39,0.95),rgba(75,27,23,0.92))] px-8 py-10 text-white sm:px-10 lg:px-14">
          <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
            <div className="space-y-4">
              <span className="eyebrow border-white/20 bg-white/10 text-white/80">季节提示</span>
