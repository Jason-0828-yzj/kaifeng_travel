  ...
  return (
    <article className="panel-strong overflow-hidden">
      ...
      <div className="space-y-4 p-6">
        ...
        <div className="grid gap-3 border-t border-[color:var(--border)] pt-4 text-sm text-[color:var(--muted)] sm:grid-cols-2">
          <div className="flex items-center gap-2"><Users className="h-4 w-4 text-[color:var(--primary)]" />{itinerary.audience}</div>
          <div className="flex items-center gap-2"><Clock3 className="h-4 w-4 text-[color:var(--primary)]" />{itinerary.duration}</div>
        </div>
      </div>
    </article>
  );
